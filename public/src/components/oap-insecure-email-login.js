...
import { OapInsecureEmailLoginStyles } from './oap-insecure-email-login-styles';
...
class OapInsecureEmailLogin extends OapBaseElement {
...
window.customElements.define('oap-insecure-email-login', OapInsecureEmailLogin);
