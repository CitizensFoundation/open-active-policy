define(["exports","./oap-app.js"],function(_exports,_oapApp){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PaperInputHelper=_exports.PaperInputBehaviorImpl=_exports.PaperInputBehavior=_exports.PaperInputAddonBehavior=_exports.OapInsecureEmailLoginStyles=_exports.IronA11yAnnouncer=_exports.$paperInputBehavior=_exports.$paperInputAddonBehavior=_exports.$oapInsecureEmailLoginStyles=_exports.$ironA11yAnnouncer=void 0;const IronA11yAnnouncer=(0,_oapApp.Polymer)({_template:_oapApp.html`
    <style>
      :host {
...
this._observer=(0,_oapApp.dom)(this).observeNodes(function(info){this._initSlottedInput()}.bind(this))},detached:function(){if(this._observer){(0,_oapApp.dom)(this).unobserveNodes(this._observer);this._observer=null}},/**
...
if(this.required&&""===this.bindValue){valid=!1}else if(this.hasValidator()){valid=_oapApp.IronValidatableBehavior.validate.call(this,this.bindValue)}}this.invalid=!valid;this.fire("iron-input-validate");return valid},_announceInvalidCharacter:function(message){this.fire("iron-announce",{text:message})},_computeValue:function(bindValue){return bindValue}});const template=_oapApp.html`<style>
  :host {
    display: inline-block;
    white-space: nowrap;
    cursor: pointer;
...
_createRipple:function(){this._rippleContainer=this.$.checkboxContainer;return _oapApp.PaperInkyFocusBehaviorImpl._createRipple.call(this)}});const PaperInputAddonBehavior={attached:function(){this.fire("addon-attached")},/**
...
this._focusableElement.focus()}}}};/** @polymerBehavior */_exports.PaperInputBehaviorImpl=PaperInputBehaviorImpl;const PaperInputBehavior=[_oapApp.IronControlState,_oapApp.IronA11yKeysBehavior,PaperInputBehaviorImpl];_exports.PaperInputBehavior=PaperInputBehavior;var paperInputBehavior={PaperInputHelper:PaperInputHelper,PaperInputBehaviorImpl:PaperInputBehaviorImpl,PaperInputBehavior:PaperInputBehavior};_exports.$paperInputBehavior=paperInputBehavior;(0,_oapApp.Polymer)({_template:_oapApp.html`
    <style>
      :host {
        display: inline-block;
        float: right;
...
`,is:"paper-input-char-counter",behaviors:[PaperInputAddonBehavior],properties:{_charCounterStr:{type:String,value:"0"}},/**
   ...
   *     value: The input value.
   *     invalid: True if the input value is invalid.
   */update:function(state){if(!state.inputElement){return}state.value=state.value||"";var counter=state.value.toString().length.toString();if(state.inputElement.hasAttribute("maxlength")){counter+="/"+state.inputElement.getAttribute("maxlength")}this._charCounterStr=counter}});const template$1=_oapApp.html`
<custom-style>
...
`,is:"paper-input-error",behaviors:[PaperInputAddonBehavior],properties:{/**
   ...
   *     value: The input value.
   *     invalid: True if the input value is invalid.
   */update:function(state){this._setInvalid(state.invalid)}});(0,_oapApp.Polymer)({is:"paper-input",_template:_oapApp.html`
    <style>
      :host {
        display: block;
      }
  ...
  `,behaviors:[PaperInputBehavior,_oapApp.IronFormElementBehavior],properties:{value:{// Required for the correct TypeScript type-generation
type:String}},/**
...
if(!!this.inputElement.bindValue){this.$.container._handleValueAndAutoValidate(this.inputElement)}}});const OapInsecureEmailLoginStyles=_oapApp.css`
  paper-dialog {
    padding-left: 8px;
    padding-right: 8px;
    width: 440px;
...
`;_exports.OapInsecureEmailLoginStyles=OapInsecureEmailLoginStyles;var oapInsecureEmailLoginStyles={OapInsecureEmailLoginStyles:OapInsecureEmailLoginStyles};_exports.$oapInsecureEmailLoginStyles=oapInsecureEmailLoginStyles;class OapInsecureEmailLogin extends _oapApp.OapBaseElement{static get properties(){return{correctAreaId:{type:String},areaName:{type:String},correctAreaName:{type:String},postCode:{type:String},userSpinner:{type:Boolean},confirmedAge:{type:Boolean},postCodeValidationPattern:{type:String},emailValidationPattern:{type:String},emailErrorMessage:{type:String},passwordErrorMessage:{type:String},name:{type:String},email:{type:String},submitText:{type:String},onLoginFunction:{type:Function},areaId:String,configFromServer:Object,postCodes:{type:Object},postCodesAreas:{type:Object},postCodesAreasNames:{type:Object}}}static get styles(){return[OapInsecureEmailLoginStyles]}render(){return _oapApp.html$1`
      <paper-dialog id="dialog" with-backdrop>
        ...
        <form is="iron-form" id="form">
          ...
          ${this.configFromServer.client_config.insecureEmailAgeLimit?_oapApp.html$1`
