define(["exports","./oap-app.js"],function(_exports,_oapApp){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.OapInsecureEmailLoginStyles=_exports.$oapInsecureEmailLoginStyles=void 0;const template=_oapApp.html`<style>
  :host {
...
_createRipple:function(){this._rippleContainer=this.$.checkboxContainer;return _oapApp.PaperInkyFocusBehaviorImpl._createRipple.call(this)}});const OapInsecureEmailLoginStyles=_oapApp.css`
  paper-dialog {
    padding-left: 8px;
    padding-right: 8px;
    width: 440px;
