...
<div id="radioLabel"><slot></slot></div>`;template$1.setAttribute("strip-whitespace","");/**
                                                 ...
                                                 @demo demo/index.html
                                                 */Polymer({_template:template$1,is:"paper-radio-button",behaviors:[PaperCheckedElementBehavior],hostAttributes:{role:"radio","aria-checked":!1,tabindex:0},properties:{/**
...
// centers align.
if(defaultInkSize%2!==size%2){defaultInkSize++}this.updateStyles({"--paper-radio-button-ink-size":defaultInkSize+"px"})}})}});Polymer({_template:html$1`
    <style>
      :host {
        display: inline-block;
      }
